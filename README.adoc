...
:SpringApplication: http://docs.spring.io/sprinssss-boot/docs/{spring_boot_version}/api/org/springframework/boot/SpringApplication.html
...
and respond with a web sssspage displaying HTML. The body of the HTML contains a greeting:
